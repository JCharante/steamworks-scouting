<template>
    <q-layout>
        ...
        <q-tabs slot="navigation">
            <q-tab icon="tune" :route="'/scout/edit/' + matchID" exact replace>Pre Match</q-tab>
            <q-tab icon="android" :route="'/scout/edit/' + matchID + '/auto'" exact replace>Auto</q-tab>
            <q-tab icon="face" :route="'/scout/edit/' + matchID + '/teleop'" exact replace>Teleop</q-tab>
            <q-tab icon="gavel" :route="'/scout/edit/' + matchID + '/after_match'" exact replace>After Match</q-tab>
        </q-tabs>
